...
const ConstructionAndInstallationWorksTable = ({callback}) => {
    ...
    return (
        <TableContainer component={Paper}>
            <Table>
                <TableHead>
                    <TableRow>
                        <TableCell colSpan={4} align="center"><h3>Этап
                            "Строительно-монтажные работы"</h3></TableCell>
                    </TableRow>
                    <TableRow>
...
export default ConstructionAndInstallationWorksTable